...
/* A STABLE ID FOR EVERY JOB NAME. The order record stores `sub` as the English
   TEXT, so renaming a job would orphan every past order that used it — and it
   meant the 118 names could not be translated at all, because the name was also
   the key. Both audits reported "all eight job names" in English on an
   otherwise Telugu booking sheet, every round, for the same reason.

   The English name stays the source of truth in the catalogue above. This maps
   it to an id that never changes, so `ui/i18n.js` can carry `sub.<id>` in every
   language and a screen can print the reader's. A job with no id falls back to
   its English name rather than showing a key. */
export const SUB_KEYS = {
  'Furniture assembly': 'furnitureassembly',
  'Door & lock repair': 'doorlockrepair',
  'Drilling / wall mounting': 'drillingwallmounting',
  'Curtain rod fitting': 'curtainrodfitting',
  'Modular kitchen repair': 'modularkitchenrepair',
  'Wardrobe & hinge fix': 'wardrobehingefix',
  'Bed & sofa repair': 'bedsofarepair',
  'False ceiling patch': 'falseceilingpatch',
  'Fan install / repair': 'faninstallrepair',
  'Switchboard & socket': 'switchboardsocket',
  'MCB / fuse trip': 'mcbfusetrip',
  'Wiring fault trace': 'wiringfaulttrace',
  'Inverter & battery': 'inverterbattery',
  'Light & chandelier fitting': 'lightchandelierfitting',
  'Doorbell & CCTV point': 'doorbellcctvpoint',
  'Tap & mixer repair': 'tapmixerrepair',
  'Leak detection': 'leakdetection',
  'Blocked drain / sink': 'blockeddrainsink',
  'Toilet & flush repair': 'toiletflushrepair',
  'Motor & pump': 'motorpump',
  'Overhead tank cleaning': 'overheadtankcleaning',
  'Geyser install': 'geyserinstall',
  'Pipeline replacement': 'pipelinereplacement',
  'AC service (split / window)': 'acservicesplitwindow',
  'AC install / uninstall': 'acinstalluninstall',
  'Gas refill': 'gasrefill',
  'Fridge repair': 'fridgerepair',
  'Washing machine repair': 'washingmachinerepair',
  'Microwave & OTG': 'microwaveotg',
  'Water purifier service': 'waterpurifierservice',
  'Chimney deep clean': 'chimneydeepclean',
  'Full home deep clean': 'fullhomedeepclean',
  'Bathroom deep clean': 'bathroomdeepclean',
  'Kitchen deep clean': 'kitchendeepclean',
  'Sofa & carpet shampoo': 'sofacarpetshampoo',
  'Post-construction clean': 'postconstructionclean',
  'Water tank clean': 'watertankclean',
  'Move-in / move-out': 'moveinmoveout',
  'Balcony & windows': 'balconywindows',
  'Cockroach gel': 'cockroachgel',
  'General pest (2/3 BHK)': 'generalpest23bhk',
  'Termite treatment': 'termitetreatment',
  'Bed bugs': 'bedbugs',
  'Mosquito fogging': 'mosquitofogging',
  'Rodent control': 'rodentcontrol',
  'Herbal child-safe pack': 'herbalchildsafepack',
  'Bike service at home': 'bikeserviceathome',
  'Car wash (dry / foam)': 'carwashdryfoam',
  'Interior detailing': 'interiordetailing',
  'Battery jumpstart': 'batteryjumpstart',
  'Flat tyre & puncture': 'flattyrepuncture',
  'RSA towing': 'rsatowing',
  'Periodic service pickup-drop': 'periodicservicepickupdrop',
  'Daily maid (sweep / mop / utensils)': 'dailymaidsweepmoputensils',
  'Cook (veg / non-veg)': 'cookvegnonveg',
  'Full-time housekeeping': 'fulltimehousekeeping',
  'Elder companion': 'eldercompanion',
  'Baby sitter': 'babysitter',
  'Driver on call': 'driveroncall',
  'Waxing (full / half)': 'waxingfullhalf',
  'Facial & cleanup': 'facialcleanup',
  'Haircut & styling': 'haircutstyling',
  'Manicure & pedicure': 'manicurepedicure',
  'Threading & face wax': 'threadingfacewax',
  'Bridal & party makeup': 'bridalpartymakeup',
  'Hair spa & colour': 'hairspacolour',
  'Mens grooming & beard': 'mensgroomingbeard',
  'Full body massage': 'fullbodymassage',
  'Ayurvedic / abhyanga': 'ayurvedicabhyanga',
  'Physiotherapy session': 'physiotherapysession',
  'Yoga trainer': 'yogatrainer',
  'Personal fitness trainer': 'personalfitnesstrainer',
  'Post-natal massage': 'postnatalmassage',
  'Nurse visit (injection / dressing)': 'nursevisitinjectiondressing',
  'Blood sample collection': 'bloodsamplecollection',
  'Doctor teleconsult': 'doctorteleconsult',
  'Clinical physiotherapy': 'clinicalphysiotherapy',
  'Elder care attendant (12/24h)': 'eldercareattendant1224h',
  'BP & sugar check': 'bpsugarcheck',
  'Equipment rental (oxygen, bed)': 'equipmentrentaloxygenbed',
  'Dog grooming & bath': 'doggroomingbath',
  'Vet home visit': 'vethomevisit',
  'Dog walking': 'dogwalking',
  'Boarding / day care': 'boardingdaycare',
  'Vaccination': 'vaccination',
  'Cat grooming': 'catgrooming',
  'Pet taxi': 'pettaxi',
  'Aquarium cleaning': 'aquariumcleaning',
  'School tuition (Class 1-10)': 'schooltuitionclass110',
  'IIT-JEE / NEET': 'iitjeeneet',
  'SSC / Banking / Govt exams': 'sscbankinggovtexams',
  'Spoken English': 'spokenenglish',
  'Music (keyboard / guitar / vocal)': 'musickeyboardguitarvocal',
  'Dance': 'dance',
  'Coding for kids': 'codingforkids',
  'Abacus & handwriting': 'abacushandwriting',
  'House shifting (1/2/3 BHK)': 'houseshifting123bhk',
  'Single item shift': 'singleitemshift',
  'Mini-truck / tempo on demand': 'minitrucktempoondemand',
  'Packers & packing material': 'packerspackingmaterial',
  'Intra-city parcel pickup': 'intracityparcelpickup',
  'Loading-unloading labour': 'loadingunloadinglabour',
  'Bike taxi parcel': 'biketaxiparcel',
  'Birthday decoration': 'birthdaydecoration',
  'Catering (per plate)': 'cateringperplate',
  'Tent, chairs & lighting': 'tentchairslighting',
  'Photographer / videographer': 'photographervideographer',
  'DJ & sound': 'djsound',
  'Pandit / priest services': 'panditpriestservices',
  'Mehndi artist': 'mehndiartist',
  'House-warming & pooja setup': 'housewarmingpoojasetup',
  'Wash & fold (per kg)': 'washfoldperkg',
  'Dry cleaning (per garment)': 'drycleaningpergarment',
  'Steam iron': 'steamiron',
  'Shoe cleaning': 'shoecleaning',
  'Saree roll / fall / pico': 'sareerollfallpico',
  'Blouse & alteration stitching': 'blousealterationstitching',
  'Curtain cleaning': 'curtaincleaning',
};
export const subKey = name => SUB_KEYS[name] || '';
